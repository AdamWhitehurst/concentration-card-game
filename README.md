### **The Concentration Game** - ___Match two cards, get a point. But we also count your failures.___

This simple npm project is a matching game using the wonderful [Deck of Cards API](https://deckofcardsapi.com/). When you press "New Game," the API creates a new deck of only the Hearts and Spades suits, while the game logic will pull, shuffle then pull again that deck from the API, creating a deck of 52 cards, 26 pairs.
